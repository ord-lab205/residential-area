...
const THIS_ENV_TYPE = "residential_area";
...
const arr_columns__sensor_type__ra = [
  ...arr_columns__common_sensor_types,
  "dust_1_val",
  "dust_2_val",
  "dust_3_val",
];
const arr_column_params = arr_columns__sensor_type__ra.map((el, i) => {
  return `VAL${i}`;
});
...
const TUNNEL_COLUMNS = arr_columns__sensor_type__ra.join();
